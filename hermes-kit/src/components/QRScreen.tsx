...
export default function QRScreen({ status, qrPng }: QRScreenProps) {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-6">
      {/* Integración "WhatsApp / Hermes" (2026-09-04): mismo criterio que
          DashboardHeader -- navegación real de vuelta a la SPA, misma pestaña. */}
      <a
        href="/"
        className="fixed top-4 left-4 text-xs text-brand-muted hover:text-brand-gold transition-colors"
        title="Volver al Dashboard Vida Divina"
      >
        ← Vida Divina
      </a>
