# Categoría: Función Cognitiva

[🏠 Índice general de productos](../productos.md)

Suplementos enfocados en concentración, memoria, claridad mental y salud cerebral.

## Productos en esta categoría

- [Youth Capsules](#youth-capsules)
- [Brain Capsules](#brain-capsules)

---

<a id="youth-capsules"></a>
## Youth Capsules

- **Nombre comercial:** Divina Youth Capsules
- **Categoría:** Función Cognitiva / Antienvejecimiento
- **Objetivo principal:** Ayudar a sentirse y verse más joven mediante una mezcla patentada de aminoácidos esenciales.
- **Problema que ayuda a resolver:** Signos de envejecimiento, presión arterial y colesterol elevados.
- **Ingredientes principales:** L-Arginina, L-Glutamina.
...
<a id="brain-capsules"></a>
## Brain Capsules

- **Nombre comercial:** Divina Brain Capsules
- **Categoría:** Función Cognitiva
- **Objetivo principal:** Ayudar a mantener una mejor función cerebral ("como actualizar la memoria RAM").
- **Problema que ayuda a resolver:** Falta de concentración, enfoque y claridad mental.
- **Ingredientes principales:** Ginkgo Biloba, St. John's Wart (hierba de San Juan).
