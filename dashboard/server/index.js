...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    if (pathname === '/api/workspace' && req.method === 'GET') { await handleGetWorkspace(req, res); return; }
    if (pathname === '/api/workspace/reset' && req.method === 'POST') { await handleResetWorkspace(req, res); return; }
